...
nArgs = [params.nPrior,params.nP,params.dnP]
eArgs = [params.ePrior,params.eP,params.deP]

pos_i,chain = func.Best_fit(Pmatrix,Xmatrix,DHmatrix,Vc,vi,So,bo,ndim,Nw,Nc,lab,nArgs,eArgs)
...
#res = np.loadtxt('../OLD_versions/ITC_independent_4Conc/out_ind.dat')
P = res[:,0]
